...
const GoalDetail = () => {
  ...
  const handleVideoComplete = async () => {
    ...
    try {
        ...
        setCurrentQuiz([{ question: "Error loading quiz", options: ["OK"], correctAnswer: "OK" }]);
    } finally {
  ...
  const handleLevelUp = async () => {
    ...
    try {
        ...
        await api.patch('/users/add-xp', { amount: 50 });
        setGoal(data);
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border overflow-hidden min-h-[400px] flex flex-col">
              ...
              <div className="flex-1 bg-slate-50/50 p-6">
                {activeTab === 'notes' ? (
                   <NotesEditor note={currentVideo?.notes || ""} onSave={(t) => console.log(t)} />
                ) : (
